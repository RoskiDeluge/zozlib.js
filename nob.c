...
Example examples[] = {
    ...
    {
        .src_path = "./pinekin3/eepers.c",
        .bin_path = "./build/pinekin3",
        .wasm_path = "./wasm/pinekin3.wasm",
    },
};
...
static const char *compiler(void)
{
    ...
    if (cc && cc[0] != '\0')
        return cc;
    if (nob_file_exists("/opt/homebrew/opt/llvm/bin/clang"))
...
bool build_native(void)
{
    ...
    {
        cmd.count = 0;
        nob_cmd_append(&cmd, cc, "-I./include/");
